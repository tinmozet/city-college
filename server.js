...
const mongoose = require('mongoose'); // <--- (သတ်မှတ်ရန် ကျန်ခဲ့သည်ကို ဖြည့်စွက်ထားပါသည်)
const path = require('path');         // <--- (path.join သုံးရန်အတွက် ဖြည့်စွက်ထားပါသည်)
...
// ၂။ Middleware များ သတ်မှတ်ခြင်း (CORS အပါအဝင်)
app.use(cors()); // ပြင်ပမှ ဒေတာလှမ်းတောင်းခြင်းကို ခွင့်ပြုရန် (CORS Error မတက်စေရန်)
...
// ၅။ လမ်းကြောင်းများ (Routes) သတ်မှတ်ခြင်း
...
// Frontend (index.html) မှ ဖောင်ဒေတာများကို လက်ခံပြီး Database ထဲ သိမ်းဆည်းမည့် API Endpoint
...
// ဒေတာဘေ့စ်ထဲက ကျောင်းသားစာရင်း အားလုံးကို ပြန်ဖတ်မည့် API (admissions - s ပါဝင်သော လမ်းကြောင်း)
...
// ဒေတာဘေ့စ်ထဲက ကျောင်းသားစာရင်း အားလုံးကို ပြန်ဖတ်မည့် API (admission - s မပါသော လမ်းကြောင်း)
// (admin.html စာလုံးပေါင်း မှားခေါ်မိလျှင်လည်း အလုပ်လုပ်စေရန် တွဲထည့်ပေးထားပါသည်)
